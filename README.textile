...
This is a customized vim configuration set with a few plugin that I use.
It is pretty generic but has some ties to using MacVim, edit Coffee Script
and compile some LaTex.
